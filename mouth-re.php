...
<html lang="en">
    ...
    <head>
        ...
        <title> full mouth rehabilitation | Braces & Face</title>
        <!-- Header links -->
    ...
    <body>
        ...
        <!-- full mouth rehabilitation  hero banner section start -->
        <section>
        ...
        <!-- full mouth rehabilitation  hero banner section end -->
                        ...
                        <div class="row py-5">
                            <div class="col-md-10 m-auto order-1 order-md-0 order-lg-0">
                                <div class="service_section_heading">
                                    <h2> <span>full mouth</span> rehabilitation </h2>
                                </div>
                            </div>
                                ...
                                <div class="common_hero_section_content">
                                    ...
                                    <div class="chsc_para">
                                        <p>A full mouth rehabilitation is a planned procedure to restore a healthy oral
                                            cavity. In this process we make a replica of tooth structures that have been
                                            lost due to some underlying factors such as old age, medical conditions, any
                                            birth defects or any other condition. We at Braces Faces Superspeciality
                                            Dental Care have been providing one of the best full mouth rehabilitation in
                                            Pimple saudagar, to our patients with our highly skilled team of dental
                                            surgeons.
                                            <br>

                                            <b>Dental conditions that require a full mouth rehabilitation are :</b> <br>
                                            - Several Decayed teeth <br>
                                            - Multiple Missing teeth <br>
                                            - Damaged teeth due to any injury <br>
                                            - Misaligned teeth <br>
                                            - Traumatic injury <br>
                                            - Deep bite <br>
                                            - Irregular teeth <br>

                                            Depending on the condition of the patient’s oral cavity, the dentist decides
                                            what all treatment is needed. He/she then plans it accordingly, ultimately
                                            delivering the patient with healthy and perfect teeth and gums. A full mouth
                                            rehabilitation includes procedures like crown and bridges, veneers, root
                                            canal treatments, gum surgeries and orthodontic treatments.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-9 order-1 order-lg-0 order-md-0">
                                <div class="common_heading">
                                    <h2>At Braces & Faces Superspeciality Dental Care, <span>Dr. Satyajit</span> Has
                                        Successfully Placed Than 15,000+ Arches With Painless Technique & Latest
                                        Equipment.</h2>
                            ...
                            <div class="col-md-12">
                                <div class="client-review">
                                    ...
                                    <div class="client-slide">
                                        <div class="owl-carousel owl-theme owl-loaded owl-drag" id="carousel5">
                                                    ...
                                                    <div class="owl-item active"
                                                        ...
                                                        <div class="item">
                                                            <div class="client-image">
                                                                <img src="assets/img/teeth/mba-3.png" class="img-fluid">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="owl-item active"
                                                        ...
                                                        <div class="item">
                                                            <div class="client-image">
                                                                <img src="assets/img/teeth/mba-2.png" class="img-fluid">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="owl-item active"
                                                        ...
                                                        <div class="item">
                                                            <div class="client-image">
                                                                <img src="assets/img/teeth/mba-1.png" class="img-fluid">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="owl-item active"
