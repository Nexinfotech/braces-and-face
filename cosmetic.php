...
<html lang="en">
    ...
    <head>
        ...
        <title> Cosmetic Dentistry | Braces & Face</title>
        <!-- Header links -->
    ...
    <body>
        ...
        <!-- cosmetic dentistry hero banner section start -->
        <section>
        ...
        <!-- cosmetic dentistry hero banner section end -->
                        ...
                        <div class="row py-5  align-items-end">
                            <div class="col-md-10 m-auto order-1 order-md-0 order-lg-0">
                                <div class="service_section_heading">
                                    <h2><span>cosmetic</span> dentistry</h2>
                                </div>
                            </div>
                            <div class="col-md-7 order-2 order-lg-0 order-md-0">
                                <div class="common_hero_section_content">
                                    ...
                                    <div class="chsc_para">
                                        <p>Do you have crooked teeth? Or yellowish teeth? or maybe you are not happy
                                            with your jawline or your gums are too visible when you smile? Braces Faces
                                            Superspeciality Dental Care is a one stop solution for all your dental
                                            problems. We have the best cosmetic dental treatment in Pimple saudagar to
                                            treat any such cases. In our day to day life we use various cosmetics to
                                            hide any flaw in our appearance and to make us look beautiful. Cosmetic
                                            dentistry does the same to our teeth. Our teeth are a vital part of our
                                            beauty. A perfect smile, a perfect teeth alignment can enhance it. Cosmetic
                                            dentistry is generally used to refer to any dental work that improves the
                                            appearance (though not necessarily the functionality) of teeth, gums and/or
                                            bite. It primarily focuses on improving dental aesthetics like colour,
                                            position, shape, size, alignment and overall smile appearance.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 position-relative text-end order-0 ">
                                ...
                                <img src="assets/img/s_cosmetic.png" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-9 order-1 order-lg-0 order-md-0">
                                <div class="common_heading">
                                    <h2>At Braces & Faces Superspeciality Dental Care,<span> Dr. Shubhangi</span> Has
                                        Transformed Than 5,500+ Smile With Painless Technique & Latest Equipment.</h2>
                                            ...
                                            <div class="owl-stage-outer">
                                                <div class="owl-stage"
                                                    ...
                                                    <div class="owl-item active"
                                                        ...
                                                        <div class="item">
                                                            <div class="client-image">
                                                                <img src="assets/img/teeth/ba-4.png" class="img-fluid">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="owl-item active"
                                                        ...
                                                        <div class="item">
                                                            <div class="client-image">
                                                                <img src="assets/img/teeth/ba-5.png" class="img-fluid">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="owl-item active"
                                                        ...
                                                        <div class="item">
                                                            <div class="client-image">
                                                                <img src="assets/img/teeth/ba-6.png" class="img-fluid">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
