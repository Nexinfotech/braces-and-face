...
<html lang="en">
    ...
    <head>
        ...
        <title> Dentures | Braces & Face</title>
        <!-- Header links -->
    ...
    <body>
        ...
        <!-- Dentures hero banner section start -->
        <section>
        ...
        <!-- Dentures hero banner section end -->
                        ...
                        <div class="row py-3">
                            ...
                            <div class="col-md-7 order-2 order-lg-0 order-md-0">
                                <div class="common_hero_section_content">
                                    <div class="chsc_heading">
                                        <h2>Dentures</h2>
                                        <p>Our teeth Dentures service is one of the best service:</p>
                                    </div>
                                    <div class="chsc_para">
                                        <p>One of the common problems that affect the quality of life in elderly age is
                                            complete or partial loss
                                            of teeth. It literally makes them disables as they can’t eat or chew the
                                            food they love and this
                                            ultimately affects their overall health. At Braces Faces Superspeciality
                                            Dental Care we believe that
                                            everyone deserves a quality life and that’s the reason we offer denture
                                            treatment at affordable
                                            cost for elderly citizens in Pimple saudagar. Denture is nothing but a
                                            removable appliance with
                                            natural looking artificial teeth attached to a acrylic base which is placed
                                            onto your gums. Patients
                                            who do not have any single teeth present can go for removable dentures and
                                            the only fixed option
                                            is implants. After all of your fall, the facial appearance starts to change.
                                            Lower lip starts to draw in
                                            and can be prevented by placing full set dentures. Dentures can also be
                                            placed as a temporary
                                            option until one gets the implants placed.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 position-relative text-end order-0 ">
                                <span class="floating_sticker">
                                    <p>We Provide 100% Permanent Attachable Dentures</p>
                                </span>
                                <img src="assets/img/dentures.png" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-9 order-1 order-lg-0 order-md-0">
                                <div class="common_heading">
                                    <h2>At Braces & Faces Superspeciality Dental Care, <span>Dr. Satyaji</span>t Has
                                        Placed 7,300+ Dentures With Painless Technology.</h2>
                            ...
                            <div class="col-md-12">
                                <div class="client-review">
                                    ...
                                    <div class="client-slide">
                                        <div class="owl-carousel owl-theme owl-loaded owl-drag" id="carousel6">
                                                ...
                                                <div class="owl-stage-outer">
                                                    <div class="owl-stage"
                                                        ...
                                                        <div class="owl-item active"
                                                            ...
                                                            <div class="item">
                                                                <div class="client-image">
                                                                    <img src="assets/img/teeth/denturesba-1.png"
                                                                        class="img-fluid">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="owl-item active"
                                                            ...
                                                            <div class="item">
                                                                <div class="client-image">
                                                                    <img src="assets/img/teeth/denturesba-2.png"
                                                                        class="img-fluid">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="owl-item active"
                                                            ...
                                                            <div class="item">
                                                                <div class="client-image">
                                                                    <img src="assets/img/teeth/denturesba-3.png"
                                                                        class="img-fluid">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="owl-item active"
                                                            ...
                                                            <div class="item">
                                                                <div class="client-image">
                                                                    <img src="assets/img/teeth/denturesba-4.png"
                                                                        class="img-fluid">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="owl-item active"
                                                            ...
                                                            <div class="item">
                                                                <div class="client-image">
                                                                    <img src="assets/img/teeth/denturesba-5.png"
                                                                        class="img-fluid">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="owl-item active"
                                                            ...
                                                            <div class="item">
                                                                <div class="client-image">
                                                                    <img src="assets/img/teeth/mba-6.png"
                                                                        class="img-fluid">
                                                                </div>
                                                            </div>
                                                        </div>
